/**
 * @file controller.hpp
 * @brief Cascaded PID controller for the Loki torpedo AUV.
 *
 ...
 *   /target/moving_mass            → /cmd/moving_mass  (passthrough)
 *
...
private:
  ...
  double current_depth_      = 0.0;   ///< [m]   positive = deeper
  double current_heading_    = 0.0;   ///< [deg] 0-360
  double current_pitch_      = 0.0;   ///< [deg]
  double current_speed_      = 0.0;   ///< [m/s]
  double current_pitch_rate_ = 0.0;   ///< [deg/s]

  // ── Setpoints ─────────────────────────────────────────────────────────────
  double target_depth_       = 0.0;
  double target_heading_     = 0.0;
  double target_speed_       = 0.0;
  double target_moving_mass_ = 0.5;   ///< neutral on startup
  ...
  // ── Parameters ────────────────────────────────────────────────────────────
  double max_pitch_cmd_;   ///< [deg] maximum nose-down pitch command
  ...
  // ── Monitor publishers (setpoint echo) ───────────────────────────────────
